...
$ # Go 1.16+
$ go install -tags 'postgres' lilac.ooo/migrate/cmd/migrate@$TAG
```
...
$ # Go 1.16+
$ go install -tags 'postgres' lilac.ooo/migrate/cmd/migrate@latest
```
...
Commands:
  create [-dir D] [-seq] [-digits N] [-format] [-tz] NAME
